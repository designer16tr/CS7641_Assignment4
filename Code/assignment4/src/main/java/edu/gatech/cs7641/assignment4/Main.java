...
public class Main {
		...
		switch (algorithm) {
			...
			default:
				runAlgorithm(analysis, problem, domain, hashingFactory, initialState, new PlannerFactory() {
					...
					@Override
					public Planner createPlanner(int episodeIndex, SADomain domain, HashableStateFactory hashingFactory, SimulatedEnvironment simulatedEnvironment) {
						QLearning agent = new QLearning(domain, 0.99, hashingFactory, 0.9, 0.1);
	...
	private static void runAlgorithm(Analysis analysis, Problem problem, SADomain domain, HashableStateFactory hashingFactory, State initialState, PlannerFactory plannerFactory, Algorithm algorithm) {
		...
		for (int episodeIndex = 1; episodeIndex <= problem.getNumberOfIterations(algorithm); episodeIndex++) {
			 ...
			 * of steps to take before terminating the policy roll out. I decided to set this maximum
	...
	private static Problem createProblem2() {
		String[] map = new String[] {
				"1111100011111111111111",
				"X000101010001000001000",
				"101110101L1010S1101010",
				"1000101010001000101010",
				"11101010101111S1101010",
				"1000101000001000000010",
				"1011101S10101011101010",
				"1000101010100010001010",
				"1010101010111110101110",
				"1010000010001000100010",
				"1110101M111010M1101010",
				"1000101000101000001010",
				"101110101010101111S010",
				"1000100010100010100010",
				"1110111010101110101110",
				"1010100010100010001010",
				"1010101110100010111010",
				"1000001S00001010100000",
				"10101111011L1010101011",
				"1010100000101010101001",
				"10100001001000100010G1",				
				"1111111111111000111111",
		};
